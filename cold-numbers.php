...
$page_title = $category_info['cold_meta_title'];
$meta_description = $category_info['cold_meta_desc'];
...
//$data_numbers = array_reverse($data_numbers);
...
<div class="wrap">
    ...
    <div class="container">
                    ...
                    <div class="game-info">
                        <div class="card hotColdCard" style="background: #dae6ec;">
                            <div class="card-body" style="overflow-x:auto;">
                                ...
                                <p style="font-size: 12px; text-align: center"><i class="fas fa-info-circle" aria-hidden="true"></i> <?=_translate('cold-number-center-text')?></p>
                                <p style="text-align: center"><a href="javascript:void(0)" onclick="showMoreBalls()"><i class="fas fa-arrow-down" aria-hidden="true"></i>&nbsp;&nbsp;<?=_translate('view-cold-ball')?></a></p>
                                <div id="view_all_balls">
                                    <table class="numbers-his-table">
                                        ...
                                        <?php foreach ($pieces_data_numbers[1] as $number_data){ ?>
                                            <tr>
        ...
        <?php
        $query_faq = "SELECT * FROM faqs WHERE page = 'numeros-frios__".$category_info['id']."' order by id desc";
